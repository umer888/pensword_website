...
if ($max_value && $min_value === $max_value) {
    ...
    ?>
    <div class="quantity">
        <label class="quantity-label" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'g5plus-auteur' ); ?></label>
        <div class="quantity-inner">
            ...
            <input type="text" step="<?php echo esc_attr($step); ?>" min="<?php echo esc_attr($min_value); ?>"
                   ...
                   title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'g5plus-auteur' ); ?>"
