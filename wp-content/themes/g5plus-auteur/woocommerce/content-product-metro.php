...
<article <?php post_class($post_class) ?>>
    <div <?php echo implode(' ', $post_inner_attributes); ?> class="<?php echo esc_attr($post_inner_class); ?>">
        ...
        <div class="product-thumb gf-tooltip-wrap"
        ...
        <div class="product-info block-center">
            <div class="block-center-inner">
                <?php
                    ...
                    remove_action('woocommerce_after_shop_loop_item_title', array(G5Plus_Auteur()->woocommerce(), 'shop_loop_product_excerpt'),20);
                    /**
                    ...
                    add_action('woocommerce_after_shop_loop_item_title', array(G5Plus_Auteur()->woocommerce(), 'shop_loop_product_excerpt'),20);
                ?>
            </div>
        </div>
        <?php
