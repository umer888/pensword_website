...
<div class="shopping-cart-icon">
    <div class="subtotal-info-wrapper">
        <span class="total-item"><?php echo esc_html($total_item); ?> <?php esc_html_e('Items', 'g5plus-auteur'); ?></span> - <?php echo WC()->cart->get_cart_subtotal(); ?>
    </div>
    <div class="icon">
...
<div class="shopping-cart-list drop-shadow">
	<ul class="cart_list product_list_widget <?php echo esc_attr($args['list_class']); ?>">
		...
		<?php else : ?>
			<li class="empty"><?php esc_html_e( 'No products in the cart.', 'g5plus-auteur' ); ?></li>
		<?php endif; ?>
	...
	<?php if (!WC()->cart->is_empty()) : ?>
		...
		<p class="woocommerce-mini-cart__total total"><strong><?php esc_html_e( 'Subtotal', 'g5plus-auteur' ); ?>
		...
		<p class="woocommerce-mini-cart__buttons buttons">
			<a href="<?php echo esc_url(wc_get_cart_url()); ?>"
			   class="wc-forward btn btn-outline btn-sm"><?php esc_html_e('View Cart', 'g5plus-auteur'); ?></a>
			<a href="<?php echo esc_url(wc_get_checkout_url()); ?>"
			   class="checkout wc-forward btn btn-gray btn-sm"><?php esc_html_e('Checkout', 'g5plus-auteur'); ?></a>
		</p>
