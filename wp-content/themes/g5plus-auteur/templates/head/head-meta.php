...
$favicon = '';
if (is_readable(G5Plus_Auteur()->themeDir('assets/images/favicon.ico'))) {
    $favicon = G5Plus_Auteur()->themeUrl('assets/images/favicon.ico');
}
$custom_favicon = G5Plus_Auteur()->options()->get_custom_favicon();
if (isset($custom_favicon['url']) && !empty($custom_favicon['url'])) {
	$favicon = $custom_favicon['url'];
}
$custom_ios_icon144 = G5Plus_Auteur()->options()->get_custom_ios_icon144();
$custom_ios_icon114 = G5Plus_Auteur()->options()->get_custom_ios_icon114();
$custom_ios_icon72 = G5Plus_Auteur()->options()->get_custom_ios_icon72();
$custom_ios_icon57 = G5Plus_Auteur()->options()->get_custom_ios_icon57();
$custom_ios_title = G5Plus_Auteur()->options()->get_custom_ios_title();
?>
