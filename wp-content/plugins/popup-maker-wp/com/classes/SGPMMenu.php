...
class SGPMMenu
{
	...
	public function menu()
	{
		...
		$hasCurrentUserRoleInSelectedList = array_intersect($currentUser->roles, $selectedUserRoles);

		if ((!in_array('administrator', $currentUser->roles) && !is_array($selectedUserRoles)) ||
			(!in_array('administrator', $currentUser->roles) && is_array($selectedUserRoles) && empty($hasCurrentUserRoleInSelectedList))) return;
