...
<svg width='182px' height='182px' xmlns="http://www.w3.org/2000/svg"
	...
	<g> <animate attributeName="opacity" dur="4s" repeatCount="indefinite"
		begin="0s" keyTimes="0;0.33;1" values="1;1;0"></animate>
	<circle cx="50" cy="50" r="40" stroke="#eeeeee" fill="none"
		stroke-width="2" stroke-linecap="round">
	<animate attributeName="r" dur="4s" repeatCount="indefinite" begin="0s"
		keyTimes="0;0.33;1" values="0;22;44"></animate></circle></g>
	<g>
	<animate attributeName="opacity" dur="4s" repeatCount="indefinite"
		begin="2s" keyTimes="0;0.33;1" values="1;1;0"></animate>
	<circle cx="50" cy="50" r="40" stroke="#eeeeee" fill="none"
		stroke-width="2" stroke-linecap="round">
	<animate attributeName="r" dur="4s" repeatCount="indefinite" begin="2s"
		keyTimes="0;0.33;1" values="0;22;44"></animate></circle></g></svg>
<style>
body.wc-braintree-body .wc-braintree-new-payment-method-container .wc-braintree-payment-loader{
	background: rgba(255,255,255,.76);
}
body.wc-braintree-body .wc-braintree-new-payment-method-container #loading {
	position: absolute;
	left: calc(50% - 100px);
	top: calc(50% - 25px);
	z-index: 9999
...
body.wc-braintree-body .wc-braintree-new-payment-method-container .uil-ripple {
	position: absolute;
	left: calc(50% - 90px);
	top: calc(50% - 90px);
	opacity: .5;
...
body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-l {
	opacity: 0;
	animation: ld-in 3s 0.0s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-o {
	opacity: 0;
	animation: ld-in 3s 0.1s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-a {
	opacity: 0;
	animation: ld-in 3s 0.2s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-d {
	opacity: 0;
	animation: ld-in 3s 0.3s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-i {
	opacity: 0;
	animation: ld-in 3s 0.4s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-n {
	opacity: 0;
	animation: ld-in 3s 0.5s ease infinite;
}

body.wc-braintree-body .wc-braintree-new-payment-method-container .ld-g {
	opacity: 0;
...
@keyframes ld-in { 0% {
	opacity: 0;
	transform: scale(0);
}30%{opacity:1;transform:scale(1);}100%{opacity:1;transform:scale(1);}}
</style>