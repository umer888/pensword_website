    ...
    <div class="sfsi_plus_notificationBannner"></div>
     ...
     <div class="main_contant">
                ...
                <div class="">
                    <div class="row">
                        <div class="col-12 col-lg-8 col-xxl-10">
                            <p class='sfsi-top-header-subheading font-italic'> <?php _e('Simply answer the questions below', SFSI_PLUS_DOMAIN); ?> <span class='sfsi-top-banner-no-decoration'><?php _e(('at least the first 3'), SFSI_PLUS_DOMAIN); ?></span><?php _e(' - that`s it! Start by clicking on them.', SFSI_PLUS_DOMAIN); ?></p>
                                        ...
                                        <div class='d-table-row'>
                                            <div class='d-table-cell align-middle'>
                                                <div class='sfsi-premium-btn'>
                                                    <a target="_blank" href="https://www.ultimatelysocial.com/usm-premium/?withqp=1&utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" class="btn btn-success" style="font-family:helveticabold;font-size: 17px;text-decoration: none;"><?php _e('Go Premium', SFSI_PLUS_DOMAIN); ?></a>
                                                </div>
                                                <a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" style="text-decoration: none;color:#414951;font-family: helveticaneue-light;" target='_blank'><?php _e('Learn More', SFSI_PLUS_DOMAIN); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class='d-table' style='width:100%;height:100%'>
                                <div class='d-table-row'>
                                    <div class='d-table-cell align-bottom'>
                                        <a href="https://www.ultimatelysocial.com/usm-premium/?playvideo=1&utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" target="_blank"><img target="_blank" src="<?php echo SFSI_PLUS_PLUGURL; ?>images/sfsi-video-play.png" style='width:100%'></a>
                                    </div>
                                </div>
                            </div>
                        </div>   
        ...
        <div class="d-lg-none row">
            <div class="col">
                <p class="sfsi-top-banner-higligted-text"><?php _e('If you want ', SFSI_PLUS_DOMAIN); ?><span class='font-weight-bold font-italic'><?php _e('more likes & shares', SFSI_PLUS_DOMAIN); ?></span><?php _e(', more placement options, better sharing features (eg: define the text and image that gets shared), optimization for mobile, ', SFSI_PLUS_DOMAIN); ?><a target="_blank" href="https://www.ultimatelysocial.com/extra-icon-styles/?utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" class="font-italic text-success" ><?php _e('more icon design styles,', SFSI_PLUS_DOMAIN); ?></a> <a target="_blank" href="https://www.ultimatelysocial.com/animated-social-media-icons/?utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" class=" text-success font-italic"><?php _e('animated icons,', SFSI_PLUS_DOMAIN); ?></a> <a target="_blank" href="https://www.ultimatelysocial.com/themed-icons-search/" class=' text-success font-italic' ><?php _e('themed icons,', SFSI_PLUS_DOMAIN); ?></a> <?php _e('and', SFSI_PLUS_DOMAIN); ?> <a href="https://www.ultimatelysocial.com/themed-icons-search/?utm_source=usmi_settings_page&utm_campaign=top_banner&utm_medium=link" target="_blank" class=" text-success font-italic" ><?php _e('much more', SFSI_PLUS_DOMAIN); ?></a><?php _e(', then ...', SFSI_PLUS_DOMAIN); ?></p>
            </div>
        </div>
