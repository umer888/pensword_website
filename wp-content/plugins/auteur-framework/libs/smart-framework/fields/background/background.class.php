				...
				<div class="gsf-background-info">
					...
					<div>
						<input data-field-control="" type="text"
						       placeholder="<?php esc_attr_e('No background image','auteur-framework'); ?>" class="gsf-background-url"
						       name="<?php $this->theInputName(); ?>[background_image_url]"
						       value="<?php echo esc_url($field_value['background_image_url']); ?>"/>
						<button type="button" class="button gsf-background-choose-image"><?php esc_html_e('Choose Image','auteur-framework'); ?></button>
						<button type="button" class="button gsf-background-remove-image"><?php esc_html_e('Remove','auteur-framework'); ?></button>
					</div>
					<div class="gsf-background-attr">
						<div class="gsf-background-attr-title"><?php esc_html_e('Background Image Properties','auteur-framework'); ?></div>
