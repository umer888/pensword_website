			...
			<div class="gsf-field-spacing-inner">
				<?php if ($is_left): ?>
					<div class="gsf-spacing-item">
						...
						<input data-field-control="" class="gsf-spacing" type="number" placeholder="<?php esc_attr_e('Left','auteur-framework'); ?>"
				...
				<?php if ($is_right): ?>
					<div class="gsf-spacing-item">
						...
						<input data-field-control="" class="gsf-spacing" type="number" placeholder="<?php esc_attr_e('Right','auteur-framework'); ?>"
				...
				<?php if ($is_top): ?>
					<div class="gsf-spacing-item">
						...
						<input data-field-control="" class="gsf-spacing" type="number" placeholder="<?php esc_attr_e('Top','auteur-framework'); ?>"
				...
				<?php if ($is_bottom): ?>
					<div class="gsf-spacing-item">
						...
						<input data-field-control="" class="gsf-spacing" type="number" placeholder="<?php esc_attr_e('Bottom','auteur-framework'); ?>"
