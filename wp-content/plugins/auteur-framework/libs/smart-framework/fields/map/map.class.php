...
if (!class_exists('GSF_Field_Map')) {
	class GSF_Field_Map extends GSF_Field
	{
		...
		function renderContent()
		{
			...
			$placeholder = isset($this->_setting['placeholder']) ? $this->_setting['placeholder'] : esc_html__('Enter an address...','auteur-framework');
		    ?>
			<div class="gsf-field-map-inner">
				...
				<?php if (!isset($this->_setting['show_address']) || $this->_setting['show_address']): ?>
					<div class="gsf-map-address">
						...
						<button type="button" class="button"><?php echo esc_html__('Find Address','auteur-framework'); ?></button>
