			...
			<div class="gsf-theme-options-header gsf-clearfix">
				<div class="gsf-theme-options-title">
					<h3>
						...
						<span><?php esc_html_e('version','auteur-framework'); ?> <?php echo esc_html($theme->get('Version')); ?></span>
					</h3>
				</div>
				<?php if ($preset && !empty($current_preset)): ?>
					<div class="gsf-preset-action">
						<button type="button" class="button button-danger gsf-preset-action-delete"><i class="fas fa-times"></i> <?php esc_html_e('Delete Preset','auteur-framework'); ?></button>
						<a href="<?php echo esc_url(home_url('/?_gsf_preset=' . $current_preset)); ?>" target="_blank" class="button"><i class="fas fa-eye"></i> <?php esc_html_e('Preview','auteur-framework'); ?></a>
					</div>
				<?php endif;?>
			</div>
		</div>
				...
				<?php if ($preset): ?>
					<div class="gsf-theme-options-preset">
						<div class="gsf-theme-options-preset-select">
							<div>
								<?php esc_html_e('Select Preset Options...','auteur-framework'); ?>
								<i class="dashicons dashicons-arrow-down"></i>
							</div>
							<ul>
								<li data-preset=""><?php esc_html_e('Default Options','auteur-framework'); ?></li>
						...
						<button type="button" class="button button-primary gsf-theme-options-preset-create"><i class="fal fa-plus"></i> <?php esc_html_e('Create Preset Options','auteur-framework'); ?></button>
					</div>
				<?php endif;?>
				<div class="gsf-theme-options-action">
					<button class="button button-success gsf-theme-options-save-options" type="submit" name="gsf_save_option"><i class="fal fa-save"></i> <?php esc_html_e('Save Options','auteur-framework'); ?></button>
				</div>
			</div>
		</div>