		...
		<div class="gsf-popup-icon-content">
			<div class="gsf-popup-icon-left">
				<div class="gsf-popup-icon-search">
					<input type="text" placeholder="<?php esc_attr_e('Search Icon...','auteur-framework'); ?>"/>
				</div>
							...
							<div class="gsf-popup-icon-group-link" data-font-id="{{fontId}}">
								<ul>
									...
									<# if (item.iconGroup.length > 1) { #>
										<li><a data-id="" href="#"><?php esc_html_e('All Icons','auteur-framework'); ?></a> <span>({{__totalIcons}})</span></li>
									<# } #>
			...
			<div class="gsf-popup-icon-right">
				<h2 class="gsf-popup-icon-header">
					<span><?php esc_html_e('Select An Icon','auteur-framework'); ?></span>
				</h2>
					...
					<# _.each(data, function(item, fontId) { #>
						<div class="gsf-popup-icon-group-section" data-font-id="{{fontId}}">
							<h4 class="gsf-popup-icon-group-title"
							    data-msg-all="<?php esc_attr_e('All Icons','auteur-framework'); ?>"
							    data-msg-search="<?php esc_attr_e('Search result for "{0}"','auteur-framework'); ?>"><?php esc_html_e('All Icons','auteur-framework'); ?></h4>
							<ul>
