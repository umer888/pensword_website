 ...
 */
return array(
    'name'        => esc_html__('Countdown', 'auteur-framework'),
    'base'        => 'gsf_countdown',
    'icon'        => 'fa fa-clock-o',
    ...
    'params'      => array(
        ...
        array(
            ...
            'heading'    => esc_html__('Time Off', 'auteur-framework'),
            'param_name' => 'time',
        ),
        array(
            'type'       => 'textfield',
            'heading'    => esc_html__('Url Redirect', 'auteur-framework'),
        ...
        array(
            'type' => 'colorpicker',
            'heading' => esc_html__('Number Color', 'auteur-framework'),
