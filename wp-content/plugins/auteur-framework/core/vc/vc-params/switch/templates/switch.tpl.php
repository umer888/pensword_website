...
$on_text = isset($settings['on_text']) ? $settings['on_text'] : esc_html__('On','auteur-framework');
$off_text = isset($settings['off_text']) ? $settings['off_text'] : esc_html__('Off','auteur-framework');
