...
<div class="gsf-vc-icon-picker-wrapper">
	...
	<div class="vc-icons-selector fip-vc-theme-grey" style="position: relative;">
		<div class="selector" style="width: auto;display: inline-block;">
			...
			<span title="<?php esc_attr_e('Chose an icon', 'auteur-framework') ?>" class="selector-button gsf-add-icon"><i class="fas fa-upload"></i></span>
            <span style="display:<?php echo esc_attr($value === '' ? 'none' : 'inline-block')   ?>" title="<?php esc_attr_e('Remove an icon', 'auteur-framework') ?>" class="selector-button gsf-remove-icon"><i class="fa fa-times"></i></span>
		</div>
	</div>
</div>
